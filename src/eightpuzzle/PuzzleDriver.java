...
public class PuzzleDriver {
    ...
    //Use map to count # of instances of a depth during testing
    //Use another map (use depth for key in BOTH) to keep track of sum of times to run, then divide for average
